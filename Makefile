#############################################################################
# Makefile for building: bak1
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Jun 16 16:48:55 2012
# Project:  bak1.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile bak1.pro
#############################################################################
...
Makefile: bak1.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile bak1.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/bak11.0.0 || $(MKDIR) .tmp/bak11.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/bak11.0.0/ && $(COPY_FILE) --parents qmlapplicationviewer/qmlapplicationviewer.h .tmp/bak11.0.0/ && $(COPY_FILE) --parents main.cpp qmlapplicationviewer/qmlapplicationviewer.cpp .tmp/bak11.0.0/ && (cd `dirname .tmp/bak11.0.0` && $(TAR) bak11.0.0.tar bak11.0.0 && $(COMPRESS) bak11.0.0.tar) && $(MOVE) `dirname .tmp/bak11.0.0`/bak11.0.0.tar.gz . && $(DEL_FILE) -r .tmp/bak11.0.0
...
install_itemfolder_01: first FORCE
	@$(CHK_DIR_EXISTS) $(INSTALL_ROOT)/opt/bak1/qml/ || $(MKDIR) $(INSTALL_ROOT)/opt/bak1/qml/ 
	-$(INSTALL_DIR) /media/disk/kakadu/prog/qt/bak1/qml/bak1 $(INSTALL_ROOT)/opt/bak1/qml/


uninstall_itemfolder_01:  FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/bak1/qml/bak1
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/bak1/qml/ 


install_target: first FORCE
	@$(CHK_DIR_EXISTS) $(INSTALL_ROOT)/opt/bak1/bin/ || $(MKDIR) $(INSTALL_ROOT)/opt/bak1/bin/ 
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/opt/bak1/bin/$(QMAKE_TARGET)"
	-$(STRIP) "$(INSTALL_ROOT)/opt/bak1/bin/$(QMAKE_TARGET)"

uninstall_target:  FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/opt/bak1/bin/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/bak1/bin/ 
